...
class HistoryItemDecoratorTests: XCTestCase {
  ...
  func testImage() {
    ...
    XCTAssertLessThanOrEqual(itemDecorator.previewImage!.size.width, HistoryItemDecorator.previewImageSize.width)
    XCTAssertLessThanOrEqual(itemDecorator.previewImage!.size.height, HistoryItemDecorator.previewImageSize.height)
    XCTAssertLessThanOrEqual(itemDecorator.thumbnailImage!.size.width, HistoryItemDecorator.thumbnailImageSize.width)
    XCTAssertLessThanOrEqual(itemDecorator.thumbnailImage!.size.height, HistoryItemDecorator.thumbnailImageSize.height)
  }
